    ...
    <main style={{ minHeight: '100vh', background: '#F5F2ED', padding: '24px 16px 40px' }}>
      <div style={{ maxWidth: '960px', margin: '0 auto' }}>
        ...
        <div style={{ textAlign: 'center', paddingTop: '16px', marginBottom: '40px' }}>
          ...
          <p style={{ color: '#6B6966', fontSize: '16px', maxWidth: '500px', margin: '0 auto', lineHeight: '1.6' }}>Build a successful business with everything provided for you. Join thousands of agents building financial freedom.</p>
        </div>
